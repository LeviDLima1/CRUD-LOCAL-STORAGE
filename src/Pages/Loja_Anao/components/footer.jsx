                ...
                <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        <div className='flex flex-col items-center'>
                            ...
                            <img src={Logo} class=" h-8 sm:h-44 rounded-full" alt="logo" />
                            
                            <div class="flex mt-8 space-x-6 text-gray-200">
                        ...
                        <div class="grid grid-cols-1 gap-16 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-2">
                            <div className='flex flex-col justify-center'>
                                <p class='bg-gray-900 text-gray-300 rounded-md px-2 py-2 text-sm sm:text-xl font-medium'>
                                    Company
                                </p>
                                <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-200 px-2">
