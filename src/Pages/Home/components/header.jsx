...
const navigation = [
    { name: 'Cadastros', href: '/home', current: true },
    { name: 'Projetos', href: '#', current: false },
    { name: 'Funcionarios', href: '/funcionarios', current: false },
];
        ...
        <>
            <Disclosure as="nav" className="bg-gray-800">
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                    <div>
                        <a href="/loja" className='bg-white w-3 h-1 absolute mt-36 text-transparent'>.</a>
                    </div>
                    <div className="relative flex h-16 items-center justify-between">
                        ...
                        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                            <button
                                type="button"
                                className="relative cursor-pointer rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden"
                            >
